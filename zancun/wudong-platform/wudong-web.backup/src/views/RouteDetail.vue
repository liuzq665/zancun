  ...
  <div class="route-detail-page">
        ...
        <div class="route-overview card">
          ...
          <div class="overview-image">
            <el-image
              ...
              fit="cover"
              class="cover-image"
              :preview-src-list="[routeInfo.coverImage || '/placeholder.svg']"
            />
          </div>
        </div>
    ...
    <el-dialog v-model="showBookingDialog" title="预订路线" width="640px" class="booking-dialog">
      <div class="dialog-route-info">
        <el-image :src="routeInfo.coverImage" fit="cover" class="dialog-image" :preview-src-list="[routeInfo.coverImage]" preview-teleported />
